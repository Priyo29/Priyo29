...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    root = tree.getroot()
    # each length is chosen so that label + 2 + length + 2 lands the row on the
    # panel's 60-column grid; changing a label means changing its length too
...
if __name__ == '__main__':
    ...
    # CHANGE ME: the "Uptime" row counts from this date. It is currently your
    # GitHub join date (2023-09-27) — swap in your birthday for a real uptime.
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2023, 9, 27))
